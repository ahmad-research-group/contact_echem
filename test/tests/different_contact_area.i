...
[Mesh]
  [./fmg]
    ...
    file = './8mm_contact_dia.msh'  # update the correct mesh file for each case
  []
  [./rename]
...
#  active = 'se air omegaeps'
  ...
  prop_values = '28000 4.427e-05'      # update sigma and epsilon of your conducting material
  block = 'se'
  outputs = exodus
  [../]
  [./air1]
  type = ADGenericConstantMaterial
  prop_names = 'sigma eps'
  prop_values =	'0.0 1.23956e-05'      # update sigma and epsilon of your insulating material
  block = 'air'
  outputs = exodus
  [../]
  [./omegaeps]
